    ...
    <div class="container-fluid">
        <div class="main-header-left">
            <div class="responsive-logo">
                ...
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ asset('Dashboard/img/brand/logo-white.png') }}"
                        class="dark-logo-1" alt="logo"></a>
                <a href="{{ url('/' . ($page = 'index')) }}"><img src="{{ asset('Dashboard/img/brand/favicon.png') }}"
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="  drop-img  cover-image  "
                                    data-image-src="{{ asset('Dashboard/img/IMG_20230228_164207_692.jpg') }}">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ asset('Dashboard/img/IMG_20230228_164207_692.jpg') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ asset('Dashboard/img/IMG_20230228_164207_692.jpg') }}"
                                        class=""></div>
                                <div class="mr-3 my-auto">
                                    <h6>Ahmed Al Khateeb</h6><span>Programing Engineer</span>
                                </div>
                            </div>
                        </div>
