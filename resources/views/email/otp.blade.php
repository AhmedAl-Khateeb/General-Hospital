...
<head>
    ...
    <title>{{ __('dashboard.Forgot Password') }}</title>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">{{ __('dashboard.Forgot Password?') }} 🔒</h4>
                        <p class="mb-4">
                            {{ __('dashboard.Enter your email and well send you instructions to reset your password') }}
                        </p>
                        <form method="POST" action="{{ route('password.send.code') }}">
                            ...
                            <button class="btn btn-primary d-grid w-100"
                                type="submit">{{ __('dashboard.Send Reset Link') }}</button>
                        </form>

                        <div class="text-center">
                            <a href="auth-login-basic.html" class="d-flex align-items-center justify-content-center">
                                <i class="bx bx-chevron-left scaleX-n1-rtl bx-sm"></i>
                                {{ __('dashboard.Back to login') }}
                            </a>
                        </div>
                    </div>
                </div>
